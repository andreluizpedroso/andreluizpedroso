...
- **Detecção de Fraude em Cartão de Crédito** — MLOps ponta a ponta com feature store, monitoramento de drift e deploy em Kubernetes
- **Predição de Churn em Telecom** — pipeline de MLOps com rede neural em PyTorch e tracking via MLflow
- **Plataforma de Dados End-to-End** — do banco transacional ao dashboard, com dbt, Airflow e DuckDB

## 🏆 Além do código

- Competidor no [Kaggle](https://www.kaggle.com/)
- Mantenedor de projetos open source em MLOps, engenharia de dados e IA generativa
- Consultoria independente em dados e IA desde 2013

---

📫 Fale comigo: [andreluizp87@gmail.com](mailto:andreluizp87@gmail.com) · [LinkedIn](https://linkedin.com/in/andreluizpedroso) · [Portfólio](https://portifolio-andre-pedroso.vercel.app)
